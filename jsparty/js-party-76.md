**Kevin Ball:** Alright, hello party people, and welcome to another episode of JS Party, where we are every week throwing a party about JavScript and the web. I am your host this week, Kball, and I am joined by two of our amazing regular panelists, one who is a new panelist; I'm super-excited, I've loved all of her episodes so far, but I haven't been on one with her, so welcome and thank you for joining me, Emma Wedekind!
...
So in JavScript if an array is working with a range operator, streams are more like xrange(). Does that make sense so far?
...
**Kevin Ball:** Okay, and with that, let us close this segment. We're gonna take a short break, and we will be back shortly, talking about stories of the week in the JavScript and front-end space.
