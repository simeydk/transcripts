...
**Erik St. Martin:** I don't know whether it's still there, but it was pre three... There was something called RJS, where basically you wrote your JavScript functionality calling into your app in your templates using Ruby, and it generated JavScript on the outside. I was just never really a big fan of that.
...
**Brian Ketelsen:** ...JavScript interpreter?

**Erik St. Martin:** Yeah, and you can bridge between JavScript and Go, and I think that's how they're using it for queries under the hood. In my defense, I have not dug in too deep, but I knew that it does have Redis compatibility too, so I think that's really cool. And it's all in memory.
