...
**Mat Ryer:** It reminds me of actually JavScript frameworks. A lot of those are -- you essentially have data, and they're applied against a template. And then you just focus on changing that data and mutating the data in different ways. That's what they mean by reactive; the experience reacts. And when you actually work like that, it is sometimes really quite surprising what it does automatically.
