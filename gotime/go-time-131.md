...
I think about, when I make a method call, the execution kind of ping-pongs through kind of like a pinball machine... You know, when you play pinball, the ball goes through the top and it goes down to all the flippers, and I visualize myself like flippering away the edge cases... So at the bottom, all that's left is the straight path. With that sort of mental image I started thinking more about how the Ruby code, and the JavScript code, and the code in other languages that I've struggled to read the most has always been code that has a lot of cyclomatic complexity - a lot of conditionals, a lot of nested statements, a lot of visual misdirection. So sometimes the happy path will be nested inside three layers of ifs, and it's like "Well, how was I supposed to know that?"
