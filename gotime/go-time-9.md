...
**Scott Mansfield:** I find this interesting, that it directly contradicts Atwood's Law, which is "Any application that can be written in JavScript will eventually be written in JavScript." \[laughter\]

**Brian Ketelsen:** I think that's actually also true, because I'm pretty sure there's already a JavScript container engine.

**Erik St. Martin:** \{47:51\} Right. I was gonna say, when we get off this call I'm gonna have to Google 'containers in JavScript'. If it's not written in JavScript, there is probably at least bindings.
