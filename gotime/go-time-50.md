...
**Brian Ketelsen:** Now, one of the things we were talking about with indexing speed today - if you have JavScript mixed into your GOPATH with Go code, the indexing is significantly longer, which is part of my problem, because I've got this gigantic GOPATH. But I've put all of my code in my GOPATH; I just figured GOPATH is a great place to put all code, so that's why my indexing takes longer than most, because I have all these projects with JavScript stuff, and it's indexing those too, for all of its code intellisense stuff.
...
**Kris Nova:** Yeah, it's [ascii-video](https://www.npmjs.com/package/ascii-video). It's a JavScript package, of course. There you go.
