...
**Adam Barr:** Well, the state of the art issue is also there. Certainly, people come out of school - even if they did study web design (which they may not have done) and used a JavScript framework (which they may not have done), there's probably something new that's come along in the last six months, that makes their knowledge obsolete. And that's just a general problem in the industry; you get that switching jobs also. I use this framework, but now my other company is using a different framework.
